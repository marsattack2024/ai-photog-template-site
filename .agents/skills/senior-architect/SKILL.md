...
- **Conventions:** Plan first, verify before build, no `any`, security planned up front (see AGENTS.md and tasks/lessons.md)
...
npx tsx .Codex/skills/senior-architect/scripts/architecture_diagram_generator.ts [--mermaid] [--json]

# Project health: tsc, lint, route count, key files
npx tsx .Codex/skills/senior-architect/scripts/project_architect.ts [--verbose] [--json]

# Dependency summary: direct deps, audit count, circular hints
npx tsx .Codex/skills/senior-architect/scripts/dependency_analyzer.ts [--json]
```
...
**Usage:**
```bash
npx tsx .Codex/skills/senior-architect/scripts/architecture_diagram_generator.ts
npx tsx .Codex/skills/senior-architect/scripts/architecture_diagram_generator.ts --mermaid --json
```
...
**Usage:**
```bash
npx tsx .Codex/skills/senior-architect/scripts/project_architect.ts
npx tsx .Codex/skills/senior-architect/scripts/project_architect.ts --verbose --json
```
...
**Usage:**
```bash
npx tsx .Codex/skills/senior-architect/scripts/dependency_analyzer.ts
npx tsx .Codex/skills/senior-architect/scripts/dependency_analyzer.ts --audit --json
```
...
npx tsx .Codex/skills/senior-architect/scripts/architecture_diagram_generator.ts --mermaid
npx tsx .Codex/skills/senior-architect/scripts/project_architect.ts --verbose
npx tsx .Codex/skills/senior-architect/scripts/dependency_analyzer.ts --audit
```
