...
Codex can open and edit any of these scripts to adjust layouts, add new layout types, or change styling.
...
2. To export to PPTX: `node .Codex/skills/slide-deck-creator/scripts/generate_pptx.js deck.json`
3. To export to HTML: `python .Codex/skills/slide-deck-creator/scripts/generate_html.py deck.json`
...
Codex should read all three references before generating a new deck.
...
Codex can open, modify, and extend any script to add new layout types, adjust colors, or wire up image loading.
