      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center flex flex-col gap-3 mb-12">
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-normal leading-tight text-(--color-cream)">
            Book Your{" "}
            <em className="italic">Sparkle Experience</em>
          </h2>
          <p className="text-sm text-(--color-cream)/60 max-w-md mx-auto leading-relaxed">
            Seydi will be in touch within one business day to schedule your
            consultation. No pressure, no pitch. Just a real conversation about
            what your session could look like.
          </p>
          <p className="text-sm text-(--color-cream)/60">
            Prefer to call or text directly?{" "}
            <a
              href="tel:+15403000159"
        ...
        {submitted ? (
          <div className="text-center py-12 flex flex-col gap-4 bg-(--color-cream) p-10">
            ...
            <p className="text-sm text-(--color-muted) max-w-sm mx-auto leading-relaxed">
              Seydi will be in touch within one business day. Check your inbox —
              and get excited. This is the part where everything changes.
            </p>
          </div>
        ) : (
          <form
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                placeholder="What's the occasion? Which sets excite you? What are you nervous about? (optional)"
