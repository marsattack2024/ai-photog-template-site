...
The workflow is CLI-first. The human provides a brief (brand name, niche, palette, fonts, copy, images) and Codex builds the entire site. Content lives in Supabase.
