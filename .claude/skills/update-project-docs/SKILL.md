...
- `~/.claude/projects/-Users-Humberto-Documents-GitHub-002--p2p-ads-generator-Claude-Dev-Environment/memory/MEMORY.md` — current memory
...
- [ ] Would a future Claude instance benefit from knowing this? (valuable)
