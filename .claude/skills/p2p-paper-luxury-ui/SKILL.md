...
- **Full migration snapshot:** `bash .claude/skills/p2p-paper-luxury-ui/scripts/migration-status.sh` — primitive adoption, hardcoded color count by feature, hand-built tables remaining, features at zero. Run anytime to see where you stand.
